...
static enum count_function quad8_count_functions[] = {
...
static enum synapse_action quad8_synapse_actions[] = {
...
#define QUAD8_COUNT_SYNAPSES(_id) {					\
	{								\
		.actions = quad8_synapse_actions,			\
		.num_actions = ARRAY_SIZE(quad8_synapse_actions),	\
...
static struct counter_synapse quad8_count_synapses[][2] = {
...
#define QUAD8_COUNT(_id, _cntname) {				\
	.id = (_id),						\
	.name = (_cntname),					\
	.functions = quad8_count_functions,			\
	.num_functions = ARRAY_SIZE(quad8_count_functions),	\
